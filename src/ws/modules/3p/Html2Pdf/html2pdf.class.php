...
'.$content.'
        ...
        {
            if ($this->_isForOneLine) return false;
            // 2025-06-24 Discussed with Francis and decided to make this change to break page inside pdf. Might need to update 3p code later.
            if (isset($param['pagebreak']) && strtolower($param['pagebreak']) === 'true') {
                $this->pdf->AddPage(); // Trigger actual PDF page break
                return true;
            }
