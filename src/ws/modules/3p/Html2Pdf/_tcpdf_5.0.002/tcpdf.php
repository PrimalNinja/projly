	...
	*/
	class TCPDF {
		...
		public function RoundedRect($x, $y, $w, $h, $r, $round_corner='1111', $style='', $border_style=array(), $fill_color=array()) {
			$this->RWundedRectXY($x, $y, $w, $h, $r, $r, $round_corner, $style, $border_style, $fill_color);
		}
		...
		protected function startSVGElementHandler($parser, $name, $attribs) {
			...
			switch($name) {
				...
				case 'rect': {
					...
					if ($clipping) {
						$this->SVGTransform($tm);
						$this->RWundedRectXY($x, $y, $w, $h, $rx, $ry, '1111', 'CNZ', array(), array());
					} else {
						$this->StartTransform();
						$this->SVGTransform($tm);
						$obstyle = $this->setSVGStyles($svgstyle, $prev_svgstyle, $x, $y, $w, $h, 'RoundedRectXY', array($x, $y, $w, $h, $rx, $ry, '1111', 'CNZ'));
						if (!empty($obstyle)) {
							$this->RWundedRectXY($x, $y, $w, $h, $rx, $ry, '1111', $obstyle, array(), array());
						}
						$this->StopTransform();
					}
					break;
