...
function pluginPayment_NabTransact($strFullName_a, $strEmail_a, $strAddress_a, $strPostcode_a, $strInvoiceDescription_a, $strInvoiceRef_a, $strCCName_a, $strCCNumber_a, $strCCMonth_a, $strCCYear_a, $strCCSecurityCode_a, $fltAmount_a)
{
	$strResult = '';
	...
	$strMerchantID = NABTRANSACT_LIVE_MERCHANTID;
	$strMerchantPassword = NABTRANSACT_LIVE_MERCHANTPWD;
	$strURL = NABTRANSACT_LIVE_URL;
