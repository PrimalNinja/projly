...
function actionIntegrationOutboundTest($objConn_a, $strSecurityToken_a, $strDataID_a, $arrParameters_a)
{
	...
	$strSQL = "select o.g561d6970_cd14_4e7b_8ac4_460ae9f6a750_outboundguid guid, ot.g407d9323_cadb_42f2_ac4d_ae6528520610_code outboundtype_code, op.gdaa1313b_b447_4e21_9dd6_7984dd3b554c_code outboundplugin_code, o.server_id, o.authenticationtype_id 
				from ~TABLENAMEINTEGRATIONOUTBOUND~ o, ~TABLENAMEINTEGRATIONOUTBOUNDTYPE~ ot, ~TABLENAMEINTEGRATIONOUTBOUNDPLUGIN~ op where o.integrationoutboundtype_id=ot.id and o.integrationoutboundplugin_id=op.id and o.id = ~INTEGRATIONOUTBOUNDID~";
	...
	{			
		$strGUID = $arrRow['guid'];
		$strIntegrationOutboundType = $arrRow['outboundtype_code'];
		$strIntegrationOutboundPlugin = $arrRow['outboundplugin_code'];
    ...
    if (strlen($strAuthenticationTypeID) > 0) 
	{
        ...
        $strAuthenticationTypeCode = dbReadValue($objConn_a, $strSQL, __FUNCTION__);

		$strPluginSuffix = preg_replace('/[^A-Za-z0-9\-\_]/', '', $strAuthenticationTypeCode);
