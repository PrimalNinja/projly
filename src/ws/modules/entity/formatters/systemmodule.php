...
function getFormatter_systemmodule($objConn_a, $arrRowUnformatted_a, $strEntityType_a, $strEntityCode_a, $intRowNum_a, $intRecordCount_a, $intLimit_a) 
{
    ...
    $arrResult = array(
        ...
        "dependencies" => $arrRowUnformatted_a['gdb7a73ca_38b3_43bf_9d17_a599f23507e5_dependencies'],        
