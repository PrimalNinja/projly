...
function getFormatter_transactionstatus($objConn_a, $arrRowUnformatted_a, $strEntityType_a, $strEntityCode_a, $intRowNum_a, $intRecordCount_a, $intLimit_a) 
{
    ...
    $arrResult = array(
		...
		"displayorder" => $arrRowUnformatted_a['g5af50eef_305c_454a_8800_b2b3b98d497e_displayorder'],
