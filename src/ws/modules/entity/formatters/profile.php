...
function getFormatter_profile($objConn_a, $arrRowUnformatted_a, $strEntityType_a, $strEntityCode_a, $intRowNum_a, $intRecordCount_a, $intLimit_a) 
{
    ...
    $arrResult = array(
        ...
        "code" => $arrRowUnformatted_a['f9a0f134f_54b8_4e11_81b3_02d4f51dadd0_code'],
		"isadmin" => $arrRowUnformatted_a['f9a0f134f_54b8_4e11_81b3_02d4f51dadd0_isadmin'],
		"is_default" => $arrRowUnformatted_a['f9a0f134f_54b8_4e11_81b3_02d4f51dadd0_isdefault'],
