...
function getFormatter_systemflagvalue($objConn_a, $arrRowUnformatted_a, $strEntityType_a, $strEntityCode_a, $intRowNum_a, $intRecordCount_a, $intLimit_a) 
{
    ...
    $arrResult = array(
		...
		"systemflagtype" => $arrRowUnformatted_a['ge13ca38f_41a4_4363_a9ea_c9262cfc65ac_systemflagtype'],
		"value" => $arrRowUnformatted_a['ge13ca38f_41a4_4363_a9ea_c9262cfc65ac_value'],
		"notes" => $arrRowUnformatted_a['ge13ca38f_41a4_4363_a9ea_c9262cfc65ac_notes'],
