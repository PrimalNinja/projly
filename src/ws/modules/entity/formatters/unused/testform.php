...
function getFormatter_testform($objConn_a, $arrRowUnformatted_a, $strEntityType_a, $strEntityCode_a, $intRowNum_a, $intRecordCount_a, $intLimit_a) 
{
    ...
    $arrCompetencies = array('Apple', 'Banana', 'Grapes', 'Peach');
