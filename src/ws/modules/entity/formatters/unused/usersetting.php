...
function getFormatter_usersetting($objConn_a, $arrRowUnformatted_a, $strEntityType_a, $strEntityCode_a, $intRowNum_a, $intRecordCount_a, $intLimit_a) 
{
    ...
    $arrResult = array(
		...
		"mdi" => $arrRowUnformatted_a['generalsettings_mdi'],
