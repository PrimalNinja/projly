<?php
function getFormatter_reportdatatype($objConn_a, $arrRowUnformatted_a, $strEntityType_a, $strEntityCode_a, $intRowNum_a, $intRecordCount_a, $intLimit_a) 
{
    ...
    $arrResult = array(
		...
		"modified" => $arrRowUnformatted_a['modifydatetime'],
