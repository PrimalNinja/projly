...
function getFormatter_video($objConn_a, $arrRowUnformatted_a, $strEntityType_a, $strEntityCode_a, $intRowNum_a, $intRecordCount_a, $intLimit_a) 
{
    ...
    $arrResult = array(
		...
		"url" => $arrRowUnformatted_a['gd04f7001_3055_42b5_8a1d_20f79967c656_url'],
		"version" => $strVersion,
		"isenabled" => $arrRowUnformatted_a['is_enabled'],
		"modified" => getDateStringOut($arrRowUnformatted_a['modifydatetime']),

		// put custom fields here
		"videocategory" => $arrRowUnformatted_a['gd04f7001_3055_42b5_8a1d_20f79967c656_videocategory'],
		"videosource" => $arrRowUnformatted_a['gd04f7001_3055_42b5_8a1d_20f79967c656_videosource'],
