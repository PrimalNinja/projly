...
function getFormatter_suburb($objConn_a, $arrRowUnformatted_a, $strEntityType_a, $strEntityCode_a, $intRowNum_a, $intRecordCount_a, $intLimit_a) 
{
    ...
    $arrResult = array(
		...
		"suburb" => $arrRowUnformatted_a['suburb'],
		"state" => $arrRowUnformatted_a['state'],
		"postcode" => $arrRowUnformatted_a['postcode'],
		"country" => $arrRowUnformatted_a['country'],
