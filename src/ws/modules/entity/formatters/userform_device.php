...
function getFormatter_userform_device($objConn_a, $arrRowUnformatted_a, $strEntityType_a, $strEntityCode_a, $intRowNum_a, $intRecordCount_a, $intLimit_a)
{
    ...
    $arrResult = array(
		...
		"form" => $arrRowUnformatted_a['gb044f0b5_48c7_48d6_8d6c_b1f8af44a652_systemform'],
		"device" => $arrRowUnformatted_a['gb044f0b5_48c7_48d6_8d6c_b1f8af44a652_device'],
