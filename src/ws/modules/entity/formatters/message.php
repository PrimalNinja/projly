...
function getFormatter_message($objConn_a, $arrRowUnformatted_a, $strEntityType_a, $strEntityCode_a, $intRowNum_a, $intRecordCount_a, $intLimit_a) 
{
    ...
    $arrResult = array(
		...
		"subject" => $arrRowUnformatted_a['ff3cf93a12_6df2_4983_a62b_45dd3b699609_subject'],
