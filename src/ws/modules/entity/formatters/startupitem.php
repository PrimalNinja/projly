...
function getFormatter_startupitem($objConn_a, $arrRowUnformatted_a, $strEntityType_a, $strEntityCode_a, $intRowNum_a, $intRecordCount_a, $intLimit_a) 
{
    ...
    $arrResult = array(
		...
		"priority" => $arrRowUnformatted_a['ffa23f2204_c11e_41f3_8c3e_85234a8b683c_priority'],
		"public" => $arrRowUnformatted_a['ffa23f2204_c11e_41f3_8c3e_85234a8b683c_public'],
