...
function getFormatter_user($objConn_a, $arrRowUnformatted_a, $strEntityType_a, $strEntityCode_a, $intRowNum_a, $intRecordCount_a, $intLimit_a) 
{
    ...
    $arrResult = array(
		...
		"email_address" => $arrRowUnformatted_a['email_address'],
		"login" => $arrRowUnformatted_a['login'],
		"userstatus" => $arrRowUnformatted_a['1d3fbeab_d440_4329_9b9c_aa93f6fe7c16_userstatus'],
