...
function getFormatter_filefieldexclusion($objConn_a, $arrRowUnformatted_a, $strEntityType_a, $strEntityCode_a, $intRowNum_a, $intRecordCount_a, $intLimit_a) 
{
    ...
    $arrResult = array(
		...
		"exclusion" => $arrRowUnformatted_a['g44107c60_2977_4385_9eb0_2bfc71bb76e4_exclusion'],
