...
function getFormatter_rostertemplate($objConn_a, $arrRowUnformatted_a, $strEntityType_a, $strEntityCode_a, $intRowNum_a, $intRecordCount_a, $intLimit_a) 
{
    ...
    $arrResult = array(
		...
		"effectivedate" => getDateStringOut($arrRowUnformatted_a['g796a111e_0b17_4965_8683_af5528feab09_effectivedate']),
