...
function getFormatter_systemmodule_navitem($objConn_a, $arrRowUnformatted_a, $strEntityType_a, $strEntityCode_a, $intRowNum_a, $intRecordCount_a, $intLimit_a) 
{
    ...
    $arrResult = array(
        ...
        "navitem" => $arrRowUnformatted_a['gc209b671_55f5_4c07_bfb9_a9231f3c0c20_navitem'],
