...
function getFormatter_workqueueitemtype($objConn_a, $arrRowUnformatted_a, $strEntityType_a, $strEntityCode_a, $intRowNum_a, $intRecordCount_a, $intLimit_a) 
{
    ...
    $arrResult = array(
		...
		"level" => $arrRowUnformatted_a['ff6155f1a0_0a1d_4130_ac46_4a4f95b3e4df_level'],
