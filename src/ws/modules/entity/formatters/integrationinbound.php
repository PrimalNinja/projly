...
function getFormatter_integrationinbound($objConn_a, $arrRowUnformatted_a, $strEntityType_a, $strEntityCode_a, $intRowNum_a, $intRecordCount_a, $intLimit_a) 
{
    ...
    $arrResult = array(
        ...
        "inboundtype" => $arrRowUnformatted_a['g8fbd6661_d8e6_4279_b9a5_5e1042970937_integrationinboundtype'],
		"usewhitelist" => $arrRowUnformatted_a['g8fbd6661_d8e6_4279_b9a5_5e1042970937_use_whitelist'],
