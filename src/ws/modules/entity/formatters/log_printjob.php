...
function getFormatter_log_printjob($objConn_a, $arrRowUnformatted_a, $strEntityType_a, $strEntityCode_a, $intRowNum_a, $intRecordCount_a, $intLimit_a) 
{
    ...
    $arrResult = array(
		...
		"jobdatetime" => getDateStringOut($arrRowUnformatted_a['gb398c9db_2272_4748_907c_d9685b924329_jobdatetime']),
