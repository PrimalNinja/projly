...
function getFormatter_todo($objConn_a, $arrRowUnformatted_a, $strEntityType_a, $strEntityCode_a, $intRowNum_a, $intRecordCount_a, $intLimit_a) 
{
    ...
    $arrResult = array(
		...
		"status" => $arrRowUnformatted_a['g3a581000_5d59_4332_b5b1_e24a1c302444_status'],
