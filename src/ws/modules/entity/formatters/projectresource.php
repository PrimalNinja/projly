...
function getFormatter_projectresource($objConn_a, $arrRowUnformatted_a, $strEntityType_a, $strEntityCode_a, $intRowNum_a, $intRecordCount_a, $intLimit_a) 
{
    ...
    $arrResult = array(
		...
		"resourcetype" => $arrRowUnformatted_a['ff31dde036_5ea2_4d57_9b43_704671d5ae78_projectresourcetype'],
		"costcategory" => $arrRowUnformatted_a['ff31dde036_5ea2_4d57_9b43_704671d5ae78_projectcostcategory'],
		"billingcategory" => $arrRowUnformatted_a['ff31dde036_5ea2_4d57_9b43_704671d5ae78_projectbillingcategory'],
