...
function getFormatter_transaction($objConn_a, $arrRowUnformatted_a, $strEntityType_a, $strEntityCode_a, $intRowNum_a, $intRecordCount_a, $intLimit_a) 
{
    //$arrJSONData = json_decode($arrRowUnformatted_a['jsondata'], true);
      
	// JC TODO - do workqueue creation here
	//debug('JC: todo - that is where we will put the work queue creation');
