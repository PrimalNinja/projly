...
function getFormatter_faq($objConn_a, $arrRowUnformatted_a, $strEntityType_a, $strEntityCode_a, $intRowNum_a, $intRecordCount_a, $intLimit_a) 
{
    ...
    $arrResult = array(
		...
		"question" => $arrRowUnformatted_a['g29a00f7a_6ca5_40d5_8e68_bd8259559f30_question'],
		"answer" => $arrRowUnformatted_a['g29a00f7a_6ca5_40d5_8e68_bd8259559f30_answer'],
