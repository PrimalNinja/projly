...
function getFormatter_blogger($objConn_a, $arrRowUnformatted_a, $strEntityType_a, $strEntityCode_a, $intRowNum_a, $intRecordCount_a, $intLimit_a) 
{
    //$arrJSONData = json_decode($arrRowUnformatted_a['jsondata'], true);
        
    $strText = formValueGetBySectionCodeFieldCode( $arrJSONData, 'g95ca647e-5947-49c4-876e-49c7f68e980b', 'TEXT1' );
    ...
    $arrResult = array(
        ...
        "date" => getDateStringOut($arrRowUnformatted_a['g95ca647e_5947_49c4_876e_49c7f68e980b_date']),
        "systemform" => $arrRowUnformatted_a['g95ca647e_5947_49c4_876e_49c7f68e980b_systemform'],
        "text1" => $strText,
