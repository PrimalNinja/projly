...
function getFormatter_projectcostcategory($objConn_a, $arrRowUnformatted_a, $strEntityType_a, $strEntityCode_a, $intRowNum_a, $intRecordCount_a, $intLimit_a) 
{
    ...
    $arrResult = array(
		...
		"costperday" => $arrRowUnformatted_a['ffd2895d59_de03_4d21_9489_20ff6ea8081d_costperday'],
		"costperhour" => $arrRowUnformatted_a['ffd2895d59_de03_4d21_9489_20ff6ea8081d_costperhour'],
