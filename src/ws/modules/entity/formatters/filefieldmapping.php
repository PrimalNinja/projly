...
function getFormatter_filefieldmapping($objConn_a, $arrRowUnformatted_a, $strEntityType_a, $strEntityCode_a, $intRowNum_a, $intRecordCount_a, $intLimit_a) 
{
    ...
    $arrResult = array(
		...
		"from" => $arrRowUnformatted_a['g3b85cacf_9b3f_464b_b76b_2f2fa7b5fcc0_from'],
		"to" => $arrRowUnformatted_a['g3b85cacf_9b3f_464b_b76b_2f2fa7b5fcc0_to'],
