...
function getFormatter_projectbillingcategory($objConn_a, $arrRowUnformatted_a, $strEntityType_a, $strEntityCode_a, $intRowNum_a, $intRecordCount_a, $intLimit_a) 
{
    ...
    $arrResult = array(
		...
		"chargeoutperday" => $arrRowUnformatted_a['ffa69783fa_2aa4_429b_a7ac_ec5028c4632a_chargeoutperday'],
		"chargeoutperhour" => $arrRowUnformatted_a['ffa69783fa_2aa4_429b_a7ac_ec5028c4632a_chargeoutperhour'],
