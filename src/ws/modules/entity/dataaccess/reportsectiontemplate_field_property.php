...
function add_reportsectiontemplate_field_property($objConn_a, $arrFormFields_a, $arrDBFields_a)
{
	$arrJSONData = getFormTemplate_reportsectiontemplate_field_property($objConn_a);
	return addbulk_reportsectiontemplate_field_property($objConn_a, $arrFormFields_a, $arrDBFields_a, $arrJSONData);
}

// bulk add method where template is fetched beforehand
function addbulk_reportsectiontemplate_field_property($objConn_a, $arrFormFields_a, $arrDBFields_a, $arrJSONData_a)
{
	$strTableNameREPORTSECTIONTEMPLATE_FIELD_PROPERTY = getTableNameEntity("reportsectiontemplate_field_property", false);	

	$strResult = "";
	
	$strClientID = $_SESSION['server_loggedin_clientid'];
	$strEntityID = getEntityID($objConn_a, "systemform");
	$strDataEntityID = getEntityID($objConn_a, "reportsectiontemplate_field_property");
	$strCode = "REPORTSECTIONTEMPLATE_FIELD_PROPERTY";
	$strDescription = "REPORTSECTIONTEMPLATE_FIELD_PROPERTY";
	...
	foreach ($arrFormFields_a as $arrField)
	{
		...
		$strFormSection = "gb21acb1b-9f1f-4d84-bac4-cb9a314e5a38r";
    ...
    $strSQL = "insert into ~TABLENAMEREPORTSECTIONTEMPLATE_FIELD_PROPERTY~ (~FIELDS~) values (~VALUES~)";
    $strSQL = str_replace('~FIELDS~', $strSQLFields, $strSQL);
    $strSQL = str_replace('~VALUES~', $strSQLValues, $strSQL);
	$strSQL = str_replace('~TABLENAMEREPORTSECTIONTEMPLATE_FIELD_PROPERTY~', ff($strTableNameREPORTSECTIONTEMPLATE_FIELD_PROPERTY), $strSQL);
	...
	exposeEntityData($objConn_a, "SYSTEMFORM", "REPORTSECTIONTEMPLATE_FIELD_PROPERTY", $strResult, $strJSONData);
...
function delete_reportsectiontemplate_field_property($objConn_a, $strID_a, $varCustomWhere_a)
{
	$strTableNameREPORTSECTIONTEMPLATE_FIELD_PROPERTY = getTableNameEntity("reportsectiontemplate_field_property", false);	

	dbBeginTrans($objConn_a, __FUNCTION__);

	$strWhere = buildWhere_reportsectiontemplate_field_property($strID_a, $varCustomWhere_a);

	$strSQL = "delete from ~TABLENAMEREPORTSECTIONTEMPLATE_FIELD_PROPERTY~ where ~WHERE~";
	$strSQL = str_replace('~TABLENAMEREPORTSECTIONTEMPLATE_FIELD_PROPERTY~', ff($strTableNameREPORTSECTIONTEMPLATE_FIELD_PROPERTY), $strSQL);
...
function deleteExtension_reportsectiontemplate_field_property($objConn_a, $strID_a, $varCustomWhere_a)
{
	$strTableNameREPORTSECTIONTEMPLATE_FIELD_PROPERTYExtension = getTableNameEntityExtension("reportsectiontemplate_field_property");	

	dbBeginTrans($objConn_a, __FUNCTION__);

	$strWhere = buildWhere_reportsectiontemplate_field_property($strID_a, $varCustomWhere_a);

	$strSQL = "delete from ~TABLENAMEREPORTSECTIONTEMPLATE_FIELD_PROPERTYEXTENSION~ where ~WHERE~";
	$strSQL = str_replace('~TABLENAMEREPORTSECTIONTEMPLATE_FIELD_PROPERTYEXTENSION~', ff($strTableNameREPORTSECTIONTEMPLATE_FIELD_PROPERTYExtension), $strSQL);
    $strSQL = str_replace('~WHERE~', $strWhere, $strSQL);	
	dbExecuteSQL($objConn_a, $strSQL, __FUNCTION__);
...
function update_reportsectiontemplate_field_property($objConn_a, $arrFormFields_a, $arrDBFields_a, $strID_a, $varCustomWhere_a)
{
	$strTableNameREPORTSECTIONTEMPLATE_FIELD_PROPERTY = getTableNameEntity("reportsectiontemplate_field_property", false);	
	...
	if ($blnExpose)
	{
		$strSQL = "select jsondata returnvalue from ~TABLENAMEREPORTSECTIONTEMPLATE_FIELD_PROPERTY~ where ~WHERE~";
		$strSQL = str_replace('~TABLENAMEREPORTSECTIONTEMPLATE_FIELD_PROPERTY~', ff($strTableNameREPORTSECTIONTEMPLATE_FIELD_PROPERTY), $strSQL);    
		$strSQL = str_replace('~WHERE~', $strWhere, $strSQL);
	...
	$strSQL = "update ~TABLENAMEREPORTSECTIONTEMPLATE_FIELD_PROPERTY~ set ~UPDATEFIELDS~ where ~WHERE~";
	...
	if ($blnExpose)
	{
		exposeEntityData($objConn_a, "SYSTEMFORM", "REPORTSECTIONTEMPLATE_FIELD_PROPERTY", $strID_a, $strJSONData);
	}
	
	return dbEndTrans($objConn_a, __FUNCTION__);
}

function fetch_reportsectiontemplate_field_property($objConn_a, $strDBFields_a, $strID_a, $varCustomWhere_a, $strOrderBy_a = "")
{
	$strTableNameREPORTSECTIONTEMPLATE_FIELD_PROPERTY = getTableNameEntity("reportsectiontemplate_field_property", false);	
	...
	$strSQL = "select ~DBFIELDS~ from ~TABLENAMEREPORTSECTIONTEMPLATE_FIELD_PROPERTY~ where ~WHERE~";
	$strSQL = str_replace('~TABLENAMEREPORTSECTIONTEMPLATE_FIELD_PROPERTY~', ff($strTableNameREPORTSECTIONTEMPLATE_FIELD_PROPERTY), $strSQL);
...
function fetchValue_reportsectiontemplate_field_property($objConn_a, $strFieldName_a, $strID_a, $varCustomWhere_a)
{
	$strTableNameREPORTSECTIONTEMPLATE_FIELD_PROPERTY = getTableNameEntity("reportsectiontemplate_field_property", false);	

	$strWhere = buildWhere_reportsectiontemplate_field_property($strID_a, $varCustomWhere_a);

	$strSQL = "select ~FIELDNAME~ returnvalue from ~TABLENAMEREPORTSECTIONTEMPLATE_FIELD_PROPERTY~ where ~WHERE~";
	$strSQL = str_replace('~TABLENAMEREPORTSECTIONTEMPLATE_FIELD_PROPERTY~', ff($strTableNameREPORTSECTIONTEMPLATE_FIELD_PROPERTY), $strSQL);
...
function buildWhere_reportsectiontemplate_field_property($strID_a, $varCustomWhere_a)
{
	$strResult = "";
...
function getFormTemplate_reportsectiontemplate_field_property($objConn_a)
{
	return formTemplateGetFromDBByEntityCode($objConn_a, "REPORTSECTIONTEMPLATE_FIELD_PROPERTY");
}