...
function actionMessageSystemList($objConn_a, $strSecurityToken_a, $strDataID_a, $arrParameters_a) {
...
from (
    ...
    where m.touser_id = tu.id and m.toclient_id = tu.client_id and m.toclient_id = tc.id and m.fromuser_id = fu.id and m.fromclient_id = fu.client_id and m.fromclient_id = fc.id and m.g8938a0d4_8efc_41ed_a420_4af7b808b3f0_issystem = 'Y' and m.touser_id = ~USERID~ and m.client_id = ~CLIENTID~
