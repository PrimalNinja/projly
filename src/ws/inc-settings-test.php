...
define('USE_PHP_MAIL', 'FALSE');									// TRUE for PHP mail, FALSE for other
define('USE_SENDGRID', 'FALSE');									// TRUE for SendGrid, FALSE for other
define('SENDGRIDAPIENTRY', 'https://api.sendgrid.com/v3/mail/send');
define('SENDGRIDAPIKEY', '');
...
define('FAIL_EMAIL_DOMAIN', 'yourdomain.com');
define('FAIL_EMAIL_ADDRESS', 'contact@yourdomain.com');
define('FAIL_EMAIL_ADDRESSTO', 'contact@yourdomain.com');
define('FAIL_EMAIL_FROMNAME', 'yourdomain');
define('GENERAL_EMAIL_DOMAIN', 'yourdomain.com');
define('GENERAL_EMAIL_ADDRESS', 'contact@yourdomain.com');
define('GENERAL_EMAIL_FROMNAME', 'yourdomain');
