<?php
	...
	$_SESSION['last_clientcode'] = '';
	$_SESSION['last_login'] = '';
	unset($_SESSION['client_bypassbrowsercheck']);
	unset($_SESSION['theme']);

	header('Location: ' . APP_HOME . '?uuid=' . str_replace('.', '-', uniqid('', true)));	// ? added to the end to prevent chrome from caching redirects, refer to here: https://superuser.com/questions/304589/how-can-i-make-chrome-stop-caching-redirects and https://bugs.chromium.org/p/chromium/issues/detail?id=91740
	exit;
