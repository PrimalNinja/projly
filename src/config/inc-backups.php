	<div id="divBackupPanel" class="gb-hidden">
...
<?php
	...
	for ($intI = count($arrBackups) - 1; $intI >= 0; $intI--)
	{
		$strFilename = $arrBackups[$intI];
		if (substr($strFilename, -5) === '.json')
		{
			$strMetaData = loadFile('backups/' . $strFilename);
...
?>
				...
				<tr>
					<td><input type="radio" name="fldUpdateNumber" class="fldUpdateNumber" value="<?php echo($strUpdateNumber); ?>"></td>
