...
?>
		...
		<table>
			<tbody>
				...
				<tr>
					<td colspan="11"><b>Client DB:</b></td>
				</tr>

				<tr>
					<td><b>Main Hostname:</b></td>
					<td></td>
					<td><?php echo(DBCLIENTMAIN_HOSTNAME); ?></td>
					<td></td>
					<td><b>User:</b></td>
					<td></td>
					<td><?php echo(DBCLIENTMAIN_LOGIN); ?></td>
					<td></td>
					<td><b>Name:</b></td>
					<td></td>
					<td><?php echo(DBCLIENTMAIN_DATABASENAME); ?></td>
				</tr>

                <tr>
					<td><b>History Hostname:</b></td>
					<td></td>
					<td><?php echo(DBCLIENTHISTORY_HOSTNAME); ?></td>
					<td></td>
					<td><b>User:</b></td>
					<td></td>
					<td><?php echo(DBCLIENTHISTORY_LOGIN); ?></td>
					<td></td>
					<td><b>Name:</b></td>
					<td></td>
					<td><?php echo(DBCLIENTHISTORY_DATABASENAME); ?></td>
				</tr>

				<tr>
					<td><b>Temporary Hostname:</b></td>
					<td></td>
					<td><?php echo(DBCLIENTTEMP_HOSTNAME); ?></td>
					<td></td>
					<td><b>User:</b></td>
					<td></td>
					<td><?php echo(DBCLIENTTEMP_LOGIN); ?></td>
					<td></td>
					<td><b>Name:</b></td>
					<td></td>
					<td><?php echo(DBCLIENTTEMP_DATABASENAME); ?></td>
				</tr>
