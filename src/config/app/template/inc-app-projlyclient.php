<?php
	...
	define('APP_SHORT_NAME', '%APP_SHORT_NAME%');
	...
	define('CLIENTMODULES', '%CLIENTMODULES%');
    ...
    // social media links
    define('LINK_INSTAGRAM', '%LINK_INSTAGRAM%');
    define('LINK_FACEBOOK', '%LINK_FACEBOOK%');
    define('LINK_TWITTER', '%LINK_TWITTER%');
	define('LINK_SNAPCHAT', '%LINK_SNAPCHAT%');
	define('LINK_WECHAT', '%LINK_WECHAT%');
