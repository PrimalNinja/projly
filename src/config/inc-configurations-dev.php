	<div id="divConfigurationPanelDev" class="gb-hidden">
		<h3>DEV configurations:</h3>
...
<?php
	...
	for ($intI = count($arrConfigurationsDev) - 1; $intI >= 0; $intI--)
	{
		$strFilename = $arrConfigurationsDev[$intI];
		if (substr($strFilename, -5) === '.json')
		{
			$strMetaData = loadFile('configurations-dev/' . $strFilename);
