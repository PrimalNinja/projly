...
function dash_frmProject(objOS_a, strFormID_a, objParameters_a)
{
	var os = objOS_a;
	var m_objThis = this;
	...
	function initialiseForm()
	{
		...
		//if (strFormTitle.length === 0) 
		//{
		strFormTitle = 'Project Dashboard';
		//}	
	...
	{		
    	m_objWgtChart1 = new dash_wgtChart(os, m_strFormID, { chart: m_arrCharts['issues_lackofthroughput_past_year'] });
        m_objWgtChart2 = new dash_wgtChart(os, m_strFormID, { chart: m_arrCharts['issues_lackofthroughput_per_project_past_year'] });
        m_objWgtChart3 = new dash_wgtChart(os, m_strFormID, { chart: m_arrCharts['issues_unresolved_by_project'] });
        m_objWgtChart4 = new dash_wgtChart(os, m_strFormID, { chart: m_arrCharts['issues_unresolved_per_project'] });
    }
    ...
    function getCharts() {
        ...
        var objJSON = os.ajaxRequestCreate('projly_fetchcharts',[]);
