...
/*jsl:ignore*/
function widgetdesktopsizer_wgtDesktopSizer(a,b,d){var c=this;this.Form_allowMultipleInstances=function(){return!1};this.Form_onDblClick=function(){a.formToFront(b)};this.Form_onMouseEnter=function(){a.showMDIClose(b)};this.Form_onMouseLeave=function(){a.hideMDIClose(b)};this.Form_onPermissionCheck=function(){return!0};this.Form_onLoad=function(){a.unbindEvents(b,"gb-form-close,gb-form");a.bindEvent(c,b,".gb-form","Form","onDblClick");a.bindEvent(c,b,".gb-form","Form","onMouseEnter");a.bindEvent(c,
b,".gb-form","Form","onMouseLeave");a.bindEvent(c,b,".gb-form-close","FormClose","onClick");a.element(b,".gb-form").draggable({handle:".gb-form-handle"})};this.FormClose_onClick=function(){a.closeForm(b)}};
