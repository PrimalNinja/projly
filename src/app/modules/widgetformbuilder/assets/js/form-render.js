...
function FormRenderFn(options, element) {
          ...
          (function () {
            ...
            if (enableOther) {
              var optionAttrs = {
                ...
                name: optionName,
                class: fieldAttrs.class + ' other-option' + m_strGUID
              };
  ...
  var otherOptionCB = function otherOptionCB() {
    var otherOptions = document.getElementsByClassName('other-option' + m_strGUID);
  ...
  if (opts.render) {
    if (opts.container) {
      ...
      var renderedFormWrap = document.querySelector('.rendered-form' + m_strGUID);
      if (renderedFormWrap) {
        renderedFormWrap.emptyContainer();
        renderedFormWrap.appendFormFields(rendered);
      } else {
        renderedFormWrap = _helpers.markup('div', rendered, { className: 'rendered-form' + m_strGUID });
