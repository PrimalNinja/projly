(function (factory, window) {
    ...
    L.Control.GeoapifyAddressSearch = L.Control.extend({
        ...
        onAdd: function (map) {
            ...
            const div = this._div = L.DomUtil.create('div', `${classPrefix}-form`, container);
            const input = this._input = L.DomUtil.create('input', `${classPrefix}-address-input`, div);
            input.type = "text";
			...
			if (input.value.length >= this.options.minTextLength) {
				this._geocodeWithDelay(input.value);
			}
