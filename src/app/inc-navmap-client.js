function getNavMapClient(objOS_a, blnIsEmployer_a, blnIsIndividual_a)
{
	var os = objOS_a;
	var arrMapRow;
	...
	//Configuration - Projly
/*     if (hasPermission(['VW_CONFIGURATIONPROJLYGROUP']))
	{
        arrMapRow = ['ConfigurationProjlyGroup', 
					'ListProjectCampaignStatusButton', 
					'ListProjectCampaignTypeButton', 
					'ListProjectIssuePriorityButton', 
					'ListProjectIssueStatusButton', 
					'ListProjectIssueTypesButton', 
					'ListProjectParticipantTypesButton', 
					'ListProjectPrioritiesButton', 
					'ListProjectStatusButton',
					'ListProjectTypesButton',
					'ListProjectResourceTypesButton', 
					'ListProjectTaskPriorityButton', 
					'ListProjectTaskStatusButton'
					];
